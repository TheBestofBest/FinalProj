    ...
    return (
        <div className="relative">
            ...
            <div
                ...
                className={`absolute left-7.5 top-0 flex w-32 flex-col rounded border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${dropdownOpen === true ? "block" : "hidden"
                    }`}
            >
...
export default DropdownChattingRoom;
