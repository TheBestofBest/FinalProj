        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="grid grid-cols-6 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
                ...
                <div className="col-span-1 flex items-center">
                    <p className="font-medium">읽음</p>
                </div>
                <div className="col-span-1 hidden items-center sm:flex">
                    <p className="font-medium">보낸 사람</p>
                </div>
                <div className="col-span-3 flex items-center">
                    <p className="font-medium">제목 </p>
                </div>
                <div className="col-span-1 flex items-center">
                    <p className="font-medium">답장 </p>
                </div>
                <div className="col-span-0 flex items-center">
                ...
                >
                    <div className="col-span-3 flex items-center">
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                            ...
                            <div className="h-6 w-15  rounded-md">
                                <EnvelopeIcon
                    ...
                    <div className="col-span-1 flex items-center">
                        <p className="text-sm text-meta-3">{product.delete}</p>
                    </div>
                </div>
            ))}
        </div>
