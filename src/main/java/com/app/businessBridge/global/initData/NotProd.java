...
public class NotProd {
    ...
    CommandLineRunner initData(DepartmentService departmentService, GradeService gradeService, MemberService memberService, ChattingRoomService chattingRoomService) {
        ...
        return args -> {
            ...
            // 정산 테스트용 회원 생성
            memberService.createRebateTest(101,1001,"user4",20002,"김둘리","1234","user4@email.com",40000000L);
            memberService.createRebateTest(101,1001,"user5",20003,"박또치","1234","user5@email.com",50000000L);
            memberService.createRebateTest(102,1001,"user6",20004,"최도너","1234","user6@email.com",60000000L);
            memberService.createRebateTest(102,1001,"user7",20005,"마이콜","1234","user7@email.com",70000000L);
            memberService.createRebateTest(102,1001,"user8",20006,"고길동","1234","user8@email.com",80000000L);
